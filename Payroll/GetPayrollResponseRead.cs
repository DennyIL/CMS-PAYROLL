...
{
    class GetPayrollResponseRead : IStatefulJob
    {
        ...
        void IJob.Execute(JobExecutionContext context)
        {
            ...
            ILog logs = LogManager.GetLogger(typeof(GetPayrollResponseRead));
            ...
            try
            {
                ...
                IList<TrxPayroll> lpayroll = session.CreateCriteria(typeof(TrxPayroll))
                    .Add(Expression.Eq("StatusIFT", ParameterHelper.TRXSTATUS_PAYROLLNEW_BOOK_IFT_AFTER_FILEEXIST))
                ...
                foreach (TrxPayroll payroll in lpayroll)
                {
                    ...
                    logs.Info(">>>>>Mau masuk ParseResponseFile");
                    string outErrorDesc = "";
            ...
            try
            {
                ...
                if(file.Exists)
                {
                    ...
                    try
                    {
                        ...
                        file.CopyTo(_payroll_output_dir + "\\" + _file);
