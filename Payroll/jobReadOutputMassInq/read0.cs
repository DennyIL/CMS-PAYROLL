...
{
    class read_0 : IStatefulJob
    {
        private static String SchCode = "read_0";
        private static String SchName = "SCH Payroll D&R Mass Inq";
        private static String schInfo = "=== " + DateTime.Now + " ";
        private static int jobNumber = 0;//trx yang diproses dan dasar tabwel temporari yan g ada
        ...
        {
            ILog log = LogManager.GetLogger(typeof(read_0));
            try
            {
                if (factory == null)
                {
