...
{
    class insert_3 : IStatefulJob
    {
        private static String SchCode = "PayrollInsert_3";
        private static String SchName = "Scheduller Payroll Insert to DB";
        private static String schInfo = "";
        private static int jobNumber = 3;//trx yang diproses, ambil trxID kelipatan 10
        ...
        {
            ILog log = LogManager.GetLogger(typeof(insert_3));
            try
            {
                //log
