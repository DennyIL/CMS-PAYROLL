...
{
    class insert_8 : IStatefulJob
    {
        private static String SchCode = "PayrollInsert_8";
        private static String SchName = "Scheduller Payroll Insert to DB";
        private static String schInfo = "";
        private static int jobNumber = 8;//trx yang diproses, ambil trxID kelipatan 10
        ...
        {
            ILog log = LogManager.GetLogger(typeof(insert_8));
            try
            {
                //log
