...
{
    class insert_6 : IStatefulJob
    {
        private static String SchCode = "PayrollInsert_6";
        private static String SchName = "Scheduller Payroll Insert to DB";
        private static String schInfo = "";
        private static int jobNumber = 6;//trx yang diproses, ambil trxID kelipatan 10
        ...
        {
            ILog log = LogManager.GetLogger(typeof(insert_6));
            try
            {
                //log
