...
{
    class insert_4 : IStatefulJob
    {
        private static String SchCode = "PayrollInsert_4";
        private static String SchName = "Scheduller Payroll Insert to DB";
        private static String schInfo = "";
        private static int jobNumber = 4;//trx yang diproses, ambil trxID kelipatan 10
        ...
        {
            ILog log = LogManager.GetLogger(typeof(insert_4));
            try
            {
                //log
