...
{
    class insert_7 : IStatefulJob
    {
        private static String SchCode = "PayrollInsert_7";
        private static String SchName = "Scheduller Payroll Insert to DB";
        private static String schInfo = "";
        private static int jobNumber = 7;//trx yang diproses, ambil trxID kelipatan 10
        ...
        {
            ILog log = LogManager.GetLogger(typeof(insert_7));
            try
            {
                //log
