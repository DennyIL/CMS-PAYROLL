...
{
    class GenerateFIleBRIS : IStatefulJob
    {
        private static int jobNumber = 0;
        private static String SchCode = "Generate FIle BRIS";
        private static String SchName = "Sch Payroll Generate FIle BRIS";
        ...
        {
            ILog log = LogManager.GetLogger(typeof(GenerateFIleBRIS));
            try
            {
                if (factory == null)
                {
